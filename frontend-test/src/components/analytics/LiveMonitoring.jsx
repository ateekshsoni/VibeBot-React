...
const LiveMonitoring = ({ data, dateRange }) => {
  ...
  const generateRandomAlert = () => {
    const alertTypes = [
      { type: 'success', message: 'Automation triggered successfully', icon: CheckCircle },
      { type: 'warning', message: 'High engagement detected', icon: AlertTriangle },
      { type: 'info', message: 'New follower milestone reached', icon: Info },
      { type: 'error', message: 'Automation rate limit approached', icon: XCircle }
    ];
  ...
  const realTimeMetrics = {
    ...
    automationStatus: [
      { name: 'Comment-to-DM', status: 'active', triggers: 156, successRate: 94.2 },
      { name: 'DM Auto-Reply', status: 'active', triggers: 89, successRate: 98.1 },
      { name: 'Story Mention', status: 'active', triggers: 23, successRate: 100 },
      { name: 'Welcome Message', status: 'active', triggers: 34, successRate: 91.7 },
      { name: 'Hashtag Monitor', status: 'paused', triggers: 0, successRate: 0 },
      { name: 'Scheduled Posts', status: 'active', triggers: 12, successRate: 100 }
    ],
    performanceAlerts: [
      {
        id: 1,
  ...
  const getActivityIcon = (type) => {
    switch (type) {
      ...
      case 'engagement': return <Heart className="h-4 w-4 text-red-400" />;
      case 'follower': return <Users className="h-4 w-4 text-blue-400" />;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            {isLive ? (
              ...
              <>
                ...
                <span className="text-red-400 font-medium">Monitoring Paused</span>
              </>
            )}
          </div>
        ...
        <div className="flex items-center space-x-2">
          <Button 
            ...
            className={isLive ? "border-red-500 text-red-400" : "border-green-500 text-green-400"}
          >
            {isLive ? (
              <>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white">{realTimeMetrics.engagementRate}%</p>
                <div className="flex items-center text-green-400 text-sm">
                  <ArrowUp className="h-3 w-3 mr-1" />
                  Above average
                </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white">{realTimeMetrics.automationTriggers}</p>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white">+{realTimeMetrics.newFollowers}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-gray-800/50 border-gray-700">
          <CardHeader>
            ...
            <CardDescription>Real-time updates from your Instagram automation</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-xs">
                        {automation.triggers} triggers • {automation.successRate}% success rate
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <Button size="sm" variant="ghost" className="text-gray-400 h-6 w-6 p-0">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="font-medium">Action: {alert.action}</span>
                    </div>
                  </div>
                  <Button size="sm" variant="ghost" className="text-gray-400 ml-4">
      ...
      <Card className="bg-gray-800/50 border-gray-700">
        <CardHeader>
          ...
          <CardDescription>Live performance metrics over the last hour</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Engagement Rate Chart */}
            <div>
              <h4 className="text-sm font-medium text-gray-300 mb-3">Engagement Rate</h4>
              <div className="space-y-2">
                {[...Array(12)].map((_, i) => {
                  const value = Math.random() * 100;
                  return (
                    <div key={i} className="flex items-center space-x-2">
                      <span className="text-xs text-gray-500 w-8">{60 - i * 5}m</span>
            ...
            {/* Automation Triggers */}
            <div>
              <h4 className="text-sm font-medium text-gray-300 mb-3">Automation Triggers</h4>
              <div className="space-y-2">
                {[...Array(12)].map((_, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-center space-x-2">
                      ...
                      <span className="text-xs text-gray-400 w-8">{Math.floor(value)}</span>
                    </div>
                  );
                })}
              </div>
            ...
            {/* New Followers */}
            <div>
              <h4 className="text-sm font-medium text-gray-300 mb-3">New Followers</h4>
              <div className="space-y-2">
                {[...Array(12)].map((_, i) => {
