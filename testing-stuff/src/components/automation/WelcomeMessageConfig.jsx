...
const WelcomeMessageConfig = ({ isOpen, onClose, onSave }) => {
      ...
      sequences: [
        {
          ...
          delay: 60, // 1 minute
          message:
            "Hey there! 👋 Welcome to our community! Thanks for following us - you're awesome! ✨",
        },
        {
          id: 2,
          delay: 1440, // 24 hours
          message:
            "Hope you're loving our content so far! 😊 Here's a special 10% discount code just for new followers: WELCOME10 🎉",
        },
      ],
      isActive: true,
      triggerCount: 234,
      ...
      sequences: [
        {
          ...
          delay: 30, // 30 seconds
          message:
            "Welcome to our VIP community! 🌟 Thanks for following us! We've got some exclusive content coming your way! 💎",
        },
      ],
      isActive: true,
      triggerCount: 45,
      ...
      sequences: [
        {
          ...
          delay: 10080, // 7 days
          message:
            "Hey! 👋 We noticed you haven't engaged with our content lately. Here's what you've missed + a special comeback offer! 🔥",
        },
        {
          id: 2,
          delay: 20160, // 14 days
          message:
            "We miss you! 💔 Last chance to grab this exclusive offer before it expires: COMEBACK20 for 20% off! 🏃‍♀️",
        },
      ],
      isActive: false,
      triggerCount: 123,
  ...
  const triggerTypes = [
    ...
    {
      value: "verified_follower",
      label: "Verified User Follow",
      description: "When a verified user follows you",
    },
    {
      value: "high_engagement_follower",
      label: "High Engagement Follow",
      description: "When someone with high engagement follows",
    },
    {
      value: "inactive_follower",
      label: "Inactive Follower",
      description: "For followers who haven't engaged recently",
    },
    {
      value: "returning_follower",
      label: "Returning Follower",
      description: "When someone follows you again",
    },
  ];
  ...
  const addWelcomeFlow = () => {
    if (
      newFlow.name.trim() &&
      newFlow.sequences.every((seq) => seq.message.trim())
    ) {
      setWelcomeFlows((prev) => [
        ...prev,
        {
          id: Date.now(),
          name: newFlow.name,
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Create personalized welcome sequences for new followers
                </p>
              </div>
            </div>
        ...
        <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-200px)]">
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm mt-1">
                  Create multi-step welcome sequences that nurture new followers
                  into engaged community members. Space out messages
                  strategically to avoid overwhelming users while maintaining
                  engagement.
                </p>
              </div>
            </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2 mt-1">
                          ...
                          >
                            {
                              triggerTypes.find(
                                (t) => t.value === flow.triggerType
                              )?.label
                            }
                          </Badge>
                          <span className="text-sm text-gray-400">
                            {flow.triggerCount} triggered |{" "}
                            {flow.completionRate}% completion
                          </span>
                        </div>
                      </div>
                    </div>
                        ...
                        {flow.sequences.map((seq, index) => (
                          ...
                          >
                            ...
                            <span className="text-sm text-gray-300">
                              After {formatDelay(seq.delay)}: "
                              {seq.message.substring(0, 50)}..."
                            </span>
                          </div>
                        ))}
                      </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {newFlow.sequences.map((sequence, index) => (
                    <div
                      key={index}
                      className="flex items-start space-x-3 p-3 bg-gray-800 rounded border border-gray-600"
                    >
                      <div className="w-8 h-8 bg-pink-500 rounded-full flex items-center justify-center text-white text-sm font-bold">
                        {index + 1}
                      </div>
          ...
          <Card className="bg-gray-800/30 border-gray-700">
            <CardHeader>
              ...
              <CardDescription>
                Pre-built welcome sequences you can customize
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    sequences: [
                      {
                        delay: 60,
                        message:
                          "Hey! 👋 Welcome to our community! So glad you're here! ✨",
                      },
                      {
                        delay: 1440,
                        message:
                          "Hope you're loving our content! Here's a 10% welcome discount: WELCOME10 🎉",
                      },
                    ],
                  },
                  {
                    ...
                    sequences: [
                      {
                        delay: 30,
                        message:
                          "Welcome! 🌟 Thanks for joining our community of [niche] enthusiasts!",
                      },
                      {
                        delay: 720,
                        message:
                          "Here's a free guide that our community loves: [Link] 📚",
                      },
                      {
                        delay: 2880,
                        message:
                          "How are you finding our content so far? Any questions? Just reply! 💬",
                      },
                    ],
                  },
                  {
                    ...
                    sequences: [
                      {
                        delay: 15,
                        message:
                          "WOW! 🤩 A verified account just followed us! Welcome to our VIP circle! ✨",
                      },
                      {
                        delay: 60,
                        message:
                          "As a VIP member, you get early access to all our launches! Stay tuned! 🚀",
                      },
                    ],
                  },
                  {
                    ...
                    sequences: [
                      {
                        delay: 10080,
                        message:
                          "We miss you! 💔 Here's what's been happening while you were away... [summary]",
                      },
                      {
                        delay: 20160,
                        message:
                          "Come back! Here's a special 20% discount just for you: COMEBACK20 🏃‍♀️",
                      },
                    ],
                  },
                ].map((template, index) => (
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      {template.sequences.map((seq, seqIndex) => (
                        <div
                          key={seqIndex}
                          className="text-xs text-gray-300 bg-gray-900 p-2 rounded"
                        >
                          <span className="text-yellow-400">
                            Step {seqIndex + 1} ({formatDelay(seq.delay)}):
                          </span>
                          <br />
                          {seq.message}
                        </div>
        ...
        <div className="p-6 border-t border-gray-700 bg-gray-800/50">
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-400">
              {welcomeFlows.filter((f) => f.isActive).length} active welcome
              flows will engage new followers
            </div>
            <div className="flex items-center space-x-2">
              <Button variant="outline" onClick={onClose}>
                Cancel
