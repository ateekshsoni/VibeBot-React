...
const SchemaVisualizer = () => {
    ...
    user: {
      ...
      fields: [
        ...
        },
        {
          ...
          required: true,
          unique: true,
          description: "User email with validation",
        },
        {
          name: "firstName",
          type: "String",
    ...
    instagram: {
      ...
      fields: [
        ...
        { name: "following", type: "Number", description: "Following count" },
        {
          ...
          type: "Boolean",
          description: "Is business account",
        },
        ...
        commentToDm: {
          ...
          fields: [
            ...
            },
            {
              name: "rules",
              type: "Array",
              description: "DM automation rules",
            },
          ],
        },
        dmAutoReply: {
          ...
          fields: [
            ...
            },
            {
              name: "rules",
              type: "Array",
              description: "Reply rules with priority",
            },
          ],
        },
        storyMention: {
          ...
          fields: [
            {
              name: "enabled",
              type: "Boolean",
              description: "Story automation enabled",
            },
            {
              name: "rules",
              type: "Array",
              description: "Story mention actions",
            },
          ],
        },
        welcomeMessage: {
          ...
          fields: [
            {
              name: "isEnabled",
              type: "Boolean",
              description: "Welcome automation",
            },
            {
              name: "template",
              type: "String",
          ...
          fields: [
            {
              name: "isEnabled",
              type: "Boolean",
              description: "Hashtag monitoring",
            },
            {
              name: "hashtags",
              type: "Array",
              description: "Monitored hashtags",
            },
          ],
        },
        scheduledPosts: {
          ...
          fields: [
            {
              name: "enabled",
              type: "Boolean",
              description: "Post scheduling enabled",
            },
            {
              name: "posts",
              type: "Array",
    ...
    analytics: {
      ...
      fields: [
        ...
        },
        {
          name: "lastSyncDate",
          type: "Date",
          description: "Last analytics sync",
        },
        {
          name: "retentionDays",
          type: "Number",
    ...
    subscription: {
      ...
      fields: [
        ...
        },
        {
          name: "status",
          type: "Enum",
          options: ["active", "cancelled", "past_due"],
  ...
  const renderFieldBadges = (field) => {
    ...
    if (field.unique)
      badges.push(
        <Badge key="uniq" variant="outline" className="text-xs">
          Unique
        </Badge>
      );
    if (field.encrypted)
      badges.push(
        <Badge key="enc" variant="secondary" className="text-xs">
    ...
    if (field.default !== undefined)
      badges.push(
        <Badge key="def" variant="outline" className="text-xs">
                ...
                {selectedSection && schemaStructure[selectedSection] && (
                  <Card className="bg-gray-800/50 border-gray-700">
                    <CardHeader>
                      <div className="flex items-center space-x-2">
                        {React.createElement(
                          schemaStructure[selectedSection].icon,
                          {
                    ...
                    <CardContent>
                      {schemaStructure[selectedSection].subsections ? (
                        ...
                        <div className="space-y-4">
                          {schemaStructure[selectedSection].fields.map(
                            (field, idx) => (
                              <div
                                key={idx}
