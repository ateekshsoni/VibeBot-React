  ...
  const [storyActions, setStoryActions] = useState([
    {
      ...
      dmTemplate:
        "Thank you so much for mentioning us in your story! 🙏✨ We've reposted it with love!",
    ...
    },
    {
      ...
      actionType: "dm_only",
      dmTemplate:
        "WOW! 🌟 Thank you for featuring us, {username}! We're sending you a special VIP discount code: STORY20 for 20% off your next order! Valid for 48 hours only! 🎉",
      autoRepost: false,
      isActive: true,
      triggerCount: 23,
      followers_min: 1000,
    },
    {
      ...
      dmTemplate:
        "Hey {username}! 👋 Loved your story mention! We'd love to explore a potential collaboration. DMing you some exciting opportunities! 💼✨",
      autoRepost: false,
      isActive: false,
      triggerCount: 12,
      followers_min: 5000,
  ...
  const actionTypes = [
    {
      value: "dm_only",
      label: "Send DM Only",
      description: "Send a personalized thank you message",
    },
    {
      value: "repost_and_dm",
      label: "Repost & DM",
      description: "Repost their story and send a DM",
    },
    {
      value: "dm_and_flag",
      label: "DM & Flag for Review",
      description: "Send DM and flag for team review",
    },
    {
      value: "auto_story_reply",
      label: "Auto Story Reply",
      description: "Reply to their story automatically",
    },
  ];
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Automatically respond when users mention you in their stories
                </p>
              </div>
            </div>
        ...
        <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-200px)]">
              ...
              <CardContent className="p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-white">
                      {
                        storyActions.filter((a) => a.autoRepost && a.isActive)
                          .length
                      }
                    </p>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm mt-1">
                  We'll automatically detect when users mention your account in
                  their Instagram stories and trigger the appropriate response.
                  You can set different actions based on follower count and
                  engagement.
                </p>
              </div>
            </div>
                      ...
                      {showPreview && (
                        <div className="bg-gray-900 p-3 rounded border border-gray-600">
                          <p className="text-xs text-gray-400 mb-3">
                            Preview: User story mention workflow
                          </p>
          ...
          <Card className="bg-gray-800/30 border-gray-700 border-dashed">
            <CardHeader>
              ...
              <CardDescription>
                Define how to respond when users mention you in their Instagram
                stories
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                disabled={
                  !newAction.name.trim() || !newAction.dmTemplate.trim()
                }
          ...
          <Card className="bg-gray-800/30 border-gray-700">
            <CardHeader>
              ...
              <CardDescription>
                Pre-built responses for different scenarios
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {[
                  {
                    ...
                    actionType: "repost_and_dm",
                    dmTemplate:
                      "Thank you so much for the story mention! 🙏✨ We've shared it with our community because we love the support!",
                    repostText:
                      "Story love from @{originalPoster} 💕 Thank you!",
                    followers_min: 50,
                  },
                  {
                    name: "VIP Discount",
                    actionType: "dm_only",
                    dmTemplate:
                      "WOW! 🌟 Thanks for featuring us, {username}! Here's a special 15% discount code just for you: STORY15 ✨ Valid for 24 hours!",
                    followers_min: 500,
                  },
                  {
                    ...
                    actionType: "dm_and_flag",
                    dmTemplate:
                      "Hey {username}! 👋 Loved your story mention! We'd love to explore a potential partnership. DMing you some exciting opportunities! 💼",
                    followers_min: 2000,
                  },
                  {
                    name: "Simple Thanks",
                    actionType: "dm_only",
                    dmTemplate:
                      "Thanks for the story shoutout, {username}! 😊 It means the world to us! ❤️",
                    followers_min: 0,
                  },
                ].map((template, index) => (
                  <div
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-400 mb-2">
                      {
                        actionTypes.find((t) => t.value === template.actionType)
                          ?.label
                      }{" "}
        ...
        <div className="p-6 border-t border-gray-700 bg-gray-800/50">
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-400">
              {storyActions.filter((a) => a.isActive).length} active story
              mention rules
            </div>
            <div className="flex items-center space-x-2">
              <Button variant="outline" onClick={onClose}>
