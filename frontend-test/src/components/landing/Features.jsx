  ...
  const features = [
    {
      ...
      description: "Convert comments into private conversations automatically. Set keyword triggers to instantly DM users who comment specific words.",
      icon: MessageSquare,
    ...
    },
    {
      ...
      description: "Track engagement, growth, and automation performance with comprehensive analytics. Monitor ROI and optimize your strategy.",
      icon: BarChart3,
    ...
    },
    {
      ...
      description: "Plan and auto-post to multiple accounts with ease. Schedule posts, stories, and reels with our intuitive calendar.",
      icon: Calendar,
    ...
    },
    {
      ...
      description: "Switch and manage several client or creator accounts from one dashboard. Perfect for agencies and social media managers.",
      icon: Users,
      color: "from-orange-500 to-red-500",
      badge: "Pro Feature",
      stats: "Unlimited accounts",
      highlights: ["Team collaboration", "Client management", "Role permissions"]
    },
    {
      title: "Story Mention Automation",
      description: "Automatically respond when mentioned in stories. Engage with your audience 24/7 and never miss an opportunity.",
      icon: Camera,
    ...
    },
    {
      ...
      description: "Greet new followers with personalized welcome messages. Build relationships from the first interaction.",
      icon: Bot,
    ...
    },
    {
      ...
      description: "Monitor hashtags and automatically engage with relevant posts. Grow your audience by finding your ideal customers.",
      icon: Hash,
    ...
    },
    {
      ...
      description: "Set up intelligent auto-replies for common questions. Provide instant customer support even when you're offline.",
      icon: Zap,
    ...
    },
    {
      ...
      description: "Monitor your automations in real-time. Get instant alerts for performance issues and optimization opportunities.",
      icon: TrendingUp,
    ...
    <section id="features" className="py-20 bg-gradient-to-b from-black to-gray-900">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          >
            From comment automation to advanced analytics, VibeBot provides all the tools 
            you need to grow your Instagram presence and convert followers into customers.
          </motion.p>
        </motion.div>
                ...
                <Card className="bg-white/5 backdrop-blur-xl border-white/10 h-full group cursor-pointer">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center text-sm">
                      ...
                      <span className="text-green-400 font-medium">{feature.stats}</span>
                    </div>
