  ...
  return (
    ...
    >
      <div className="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        {(systemStatus.instagram ||
          systemStatus.backendSync ||
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-amber-700 text-sm mt-2">
              Some services are temporarily protected to prevent overload. Click
              reset to retry connections.
            </p>
          </div>
        )}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Set up intelligent automation workflows to engage your Instagram
                audience 24/7
              </p>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <SetupProgressCard stats={stats} loading={statsLoading} />
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/30">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Automatically send DMs when users comment specific
                          keywords
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/30">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Flexible or exact keyword matching with case
                          sensitivity options
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/30">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Built-in limits to prevent spam and comply with
                          Instagram policies
                        </p>
                      </div>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <ActivityFeedCard maxItems={8} showLoadMore={false} />
          </div>
        </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm text-blue-800">
                    Connect your Instagram Business account using the OAuth
                    integration above
                  </p>
                </div>
                <div className="flex items-center gap-3">
