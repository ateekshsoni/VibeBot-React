            ...
            "components/": {
              ...
              children: {
                ...
                "project/": {
                  ...
                  files: [
                    "ProjectStructureVisualizer.jsx",
                    "BackendIntegration.jsx",
                    "TechStack.jsx",
                  ],
                },
              },
  ...
  const techStack = {
    frontend: {
      ...
      technologies: [
        ...
        {
          name: "shadcn/ui",
          description: "High-quality component library",
          icon: Layout,
        },
      ...
      technologies: [
        {
          ...
          description: "Modular component architecture",
          icon: Layout,
        },
        {
          name: "Custom Hooks",
          ...
          >
            ...
            {item.color && (
              <Badge
                variant="outline"
                className={cn(
                  `border-${item.color}-200 text-${item.color}-700`
                )}
              >
                {item.type}
              </Badge>
          ...
          {isFolder && isExpanded && item.files && (
            <div className="ml-6">
              {item.files.map((file) => (
                <div
                  key={file}
                  className="flex items-center gap-2 py-1 px-2 text-sm text-gray-600 dark:text-gray-400"
                >
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Complete project documentation including file structure, technology
          stack, and backend integration guide
        </p>
      </div>
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Click on folders to expand and explore the complete project
                structure
              </p>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-4">
                {[
                    ...
                    endpoints: [
                      {
                        ...
                        description: "Instagram OAuth URL",
                      },
                      {
                        method: "POST",
                  ...
                  <div key={index} className="border rounded-lg p-4">
                    <h4
                      className={cn(
                        "font-medium mb-3 flex items-center gap-2 text-",
                        category.color,
                        "-600"
                      )}
                    >
