  ...
  const [scheduledPosts, setScheduledPosts] = useState([
    {
      ...
      type: "image",
      content:
        "Rise and grind! 💪 Monday is a fresh start to chase your dreams! What's your goal for this week? 🌟 #MondayMotivation #Goals #Success",
    ...
    },
    {
      ...
      type: "video",
      content:
        "✨ NEW FEATURE ALERT! ✨ Check out our latest update that's going to revolutionize your workflow! Swipe to see it in action 👉 #ProductUpdate #Innovation #TechLife",
    ...
    },
    {
      ...
      type: "carousel",
      content:
        "Take a peek behind the curtain! 👀 Here's how we create the magic that you see every day. Swipe through our creative process! 🎨 #BehindTheScenes #CreativeProcess #TeamWork",
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Plan, schedule, and manage your Instagram content
                </p>
              </div>
            </div>
        ...
        <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-200px)]">
              ...
              <CardContent className="p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-white">
                      {
                        scheduledPosts.filter((p) => p.status === "draft")
                          .length
                      }
                    </p>
              ...
              <CardContent className="p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-white">
                      {Math.round(
                        scheduledPosts.reduce(
                          (sum, p) => sum + p.estimatedReach,
                          0
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm mt-1">
                  Posts are automatically optimized for your audience's peak
                  engagement times. Enable "Best Time to Post" for maximum reach
                  and engagement.
                </p>
              </div>
            </div>
          ...
          <div className="flex space-x-1 bg-gray-800 p-1 rounded-lg">
            {[
              { key: "all", label: "All Posts", count: scheduledPosts.length },
              {
                key: "scheduled",
                label: "Scheduled",
                count: scheduledPosts.filter((p) => p.status === "scheduled")
                  .length,
              },
              {
                key: "drafts",
                label: "Drafts",
                count: scheduledPosts.filter((p) => p.status === "draft")
                  .length,
              },
              {
                key: "published",
                label: "Published",
                count: scheduledPosts.filter((p) => p.status === "published")
                  .length,
              },
            ].map((tab) => (
              <button
          ...
          <div className="space-y-4">
            ...
            {getFilteredPosts().map((post) => {
              const PostTypeIcon =
                postTypes.find((t) => t.value === post.type)?.icon || Image;
              const statusConfig = statusOptions.find(
                (s) => s.value === post.status
              );
                        ...
                        <div className="flex-1 space-y-2">
                          ...
                          <div className="flex items-center space-x-4 text-sm text-gray-400">
                            <span className="flex items-center space-x-1">
                              ...
                              <span>
                                {
                                  postTypes.find((t) => t.value === post.type)
                                    ?.label
                                }
                              </span>
                            </span>
              ...
              <div className="flex items-center space-x-4">
                <label className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-300">
                    Optimize for best posting time
                  </span>
                </label>
              </div>
