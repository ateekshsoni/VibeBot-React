        ...
        <CardContent className="relative p-8 text-center space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              To unlock automation, analytics, and messaging features, please
              connect your Instagram account to VibeBot.
            </p>
          </div>
          ...
          {/* Security Note */}
          <p className="text-xs text-muted-foreground">
            🔒 Your Instagram account is secured with OAuth 2.0. We never store
            your password.
          </p>
        </CardContent>
      </Card>
