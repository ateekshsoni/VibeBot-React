  ...
  const [rules, setRules] = useState([
    {
      ...
      dmTemplate:
        "Hi! Thanks for your interest! 🎉 Check your DMs for special pricing info.",
      isActive: true,
      triggerCount: 45,
    },
    {
      ...
      dmTemplate:
        "Hey there! 👋 I've sent you detailed information in your DMs. Check it out!",
      isActive: true,
      triggerCount: 23,
    },
  ]);
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Configure automatic DM responses to comments
                </p>
              </div>
            </div>
        ...
        <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-200px)]">
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm mt-1">
                  When someone comments with your specified keywords, they'll
                  automatically receive a DM with your custom message. This
                  helps capture leads and provide instant responses to common
                  questions.
                </p>
              </div>
            </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  When someone comments any of these keywords, they'll receive
                  your DM
                </p>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <Button
                  onClick={addRule}
                  disabled={
                    !newRule.keywords.trim() || !newRule.dmTemplate.trim()
                  }
          ...
          <Card className="bg-gray-800/30 border-gray-700">
            <CardHeader>
              ...
              <CardDescription>
                Click to use these proven templates
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {[
                  {
                    ...
                    template:
                      "Hi! 👋 Thanks for your interest! I've sent you detailed pricing info in your DMs. Check it out! 💰",
                  },
                  {
                    name: "General Info",
                    keywords: "info, details, more, learn",
                    template:
                      "Hey there! 🌟 I've sent you all the details in your DMs. Let me know if you have any questions!",
                  },
                  {
                    name: "Lead Magnet",
                    keywords: "download, free, guide, ebook",
                    template:
                      "Amazing! 🎉 Your free guide is waiting in your DMs. Go grab it now!",
                  },
                  {
                    name: "Support",
                    keywords: "help, support, question, issue",
                    template:
                      "Hi! 💬 I'm here to help! I've sent you some information in your DMs. Let's solve this together!",
                  },
                ].map((template, index) => (
                  <div
                    key={index}
        ...
        <div className="p-6 border-t border-gray-700 bg-gray-800/50">
          <div className="flex items-center justify-between">
            <div className="text-sm text-gray-400">
              {rules.filter((r) => r.isActive).length} active rules will process
              incoming comments
            </div>
            <div className="flex items-center space-x-2">
              <Button variant="outline" onClick={onClose}>
